...
import { addToWishlist } from "@/app/reducers/wishlistSlice";
...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-white group shadow-md rounded-lg p-4 flex flex-col">
      <div className="relative">
        <span className="absolute right-0 top-0 z-10" onClick={handleAddToWishlist}>
          {
            !wishlistedProducts ?
