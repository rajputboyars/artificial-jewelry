            ...
            <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <div className="flex space-x-6 items-center">
                    ...
                    <Link href="/wishlist" className="hover:text-secondary relative">
                        ...
                        <span className="bg-red-500 absolute -top-3 -right-3 text-sm text-white rounded-full px-1">{wishlistItems?.length}</span>
                    </Link>
                    ...
                    <Link href="/cart" className="hover:text-secondary relative">
                        ...
                        <span className="bg-red-500 absolute -top-3 -right-3 text-sm text-white rounded-full px-1">{cartItems?.length}</span>
                    </Link>
